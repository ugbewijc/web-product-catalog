...
-- id: category id, auto generated by the RDBMS and not empty
...
-- create users table
-- decription:
--  id: users id, auto generated by the RDBMS and not empty
--  email: user email, it act as username, required
